...
class FrameworkConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    private $allowedHttpMethodOverride;
     ...
     * @deprecated since Symfony 7.4
     */
    public function allowedHttpMethodOverride(ParamConfigurator|array $value): static
    {
        $this->_hasDeprecatedCalls = true;
     ...
     * @deprecated since Symfony 7.4
     */
    public function workflows(array|bool $value = []): \Symfony\Config\Framework\WorkflowsConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function validation(array|bool $value = []): \Symfony\Config\Framework\ValidationConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function serializer(array|bool $value = []): \Symfony\Config\Framework\SerializerConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function typeInfo(array|bool $value = []): \Symfony\Config\Framework\TypeInfoConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function lock(string|array|bool $value = []): \Symfony\Config\Framework\LockConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function semaphore(string|array|bool $value = []): \Symfony\Config\Framework\SemaphoreConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function httpClient(array|bool $value = []): \Symfony\Config\Framework\HttpClientConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function rateLimiter(array|bool $value = []): \Symfony\Config\Framework\RateLimiterConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function jsonStreamer(array|bool $value = []): \Symfony\Config\Framework\JsonStreamerConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['allowedHttpMethodOverride'])) {
            $output['allowed_http_method_override'] = $this->allowedHttpMethodOverride;
        }
